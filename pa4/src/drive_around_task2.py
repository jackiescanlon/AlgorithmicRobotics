...
class driveAroundNode(object):
    ...
    def setVictims(self, victims_msg):
        ...
        # Just look at the first victim for now
    ...
    def setInitialPose(self,odom_msg):
        ...
        if self.first:
            ...
            #output = open('prm_points.pkl', 'wb')
            #pickle.dump(self.g, output)
            #output.close()
            '''
            my_file = open('/home/jackie/catkin_ws/src/pa4_student/src/prm_points.pkl', 'rb')
