...
# CURRENTLY SUBSCRIBES TO KALMAN FILTER, NOT DEAD RECKONING
...
class MappingNode(object):
    ...
    def updateMap(self, odom_msg, scan_msg):
        ''' Updates the map according to a new message.'''

        # Note the odom_msg read in is a PoseStamped, not Odometry message.
    ...
    def laserArray(self, scan_msg):
        '''Gets a list of end points for the laser scans.'''
