...
class MappingNode(object):
    ...
    def __init__(self):
        ...
        self.map_info.resolution = .05
        self.map_info.height = 775
        self.map_info.width = 746
        ...
        #pose_sub = message_filters.Subscriber('/my_kalman_filter', Odometry)
        self.pose_sub = message_filters.Subscriber('/robot0/odom', Odometry)
